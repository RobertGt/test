...
if(!class_exists('DataStructs_GPSDataOpt'))
{
    ...
    {
        public function __construct($gpsTime=Ice_Unset, $rcvTime=Ice_Unset, $point=Ice_Unset, $mileage=Ice_Unset, $speed=Ice_Unset, $direction=Ice_Unset, $altitude=Ice_Unset, $battery=Ice_Unset, $messageType=Ice_Unset, $gsmStrength=Ice_Unset, $satelliteNum=Ice_Unset, $gpsAccuracyType=Ice_Unset, $theDayInitMileage=Ice_Unset)
        {
            $this->gpsTime = $gpsTime;
            $this->rcvTime = $rcvTime;
            $this->point = is_null($point) ? new DataStructs_GeoPoint : $point;
...
if(!class_exists('DataStructs_TravelInfo'))
{
    ...
    {
        public function __construct($isCompleted=true, $startPos=null, $stopPos=null, $travelMileage=0, $travelOil=0, $travelPeriod=0, $drivePeriod=0, $overSpeedCount=0, $celerateCount=0, $decelerateCount=0, $stopACCOnCount=0, $startFlag=0, $stopFlag=0, $remark="", $seqFaultCode=null)
        {
